  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Registrar Saída</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Preencha os dados da saída de estoque</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-gray-600">Saídas na Lista</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Saídas Adicionadas</CardTitle>
            <CardDescription>Revise antes de confirmar</CardDescription>
          </CardHeader>
          <CardContent>
            {saidas.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-500">Nenhuma saída adicionada ainda</p>
              </div>
            ) : (
